...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || "263780828991"  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
global.sudo = process.env.SUDO || 263780828991' 
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'MADE BY Lil tee',
   
  botname:   process.env.BOT_NAME === undefined ? "Lil tee-Md" : process.env.BOT_NAME,
